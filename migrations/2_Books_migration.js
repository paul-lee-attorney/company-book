...
module.exports = async function (deployer, network, accounts) {
    ...
    await deployer.link(LibSNParser, [IA, MR, SHA, AD, DA, FR, GU, LU, OP, TA, BOA, BOD, BOH, BOM, BOO, BOP, BOS, BOSCal, BOAKeeper, BOHKeeper, BOMKeeper, BOOKeeper, BOPKeeper, BOSKeeper, SHAKeeper, LibMotionsRepo, LibOptionsRepo]);
    ...
    await rc.regUser({from: accounts[1]});
    ...
    await bosKeeper.init(accounts[0], accounts[0], rc.address, gk.address);
    ...
    await bod.setBOS(bos.address);
    await bod.setBOSCal(bosCal.address);
